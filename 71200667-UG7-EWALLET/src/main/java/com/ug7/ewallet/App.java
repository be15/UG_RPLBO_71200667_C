...
public class App{
    ...
    public static void main(String[] args) {
        ...
        User U_71200667 = new User("Beatrix Stefany", "beatrix.stefany@ti.ukdw.ac.id", 30000);
        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71200667 = new GoPay(U_71200667);
        System.out.println("\n========== AWAL ==========");
        E_71190480.getInfo();
        E_71200667.getInfo();
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("[" + E_71200667.getUser().getNama() + "] - ");
        E_71200667.topup(10000);
        System.out.println("\n========== TOP UP #2 ==========");
        System.out.print("[" + E_71190480.getUser().getNama() + "] - ");
        E_71190480.topup(5000);
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("[" + E_71200667.getUser().getNama() + "] - ");
        E_71200667.topup(50000);
        System.out.print("[" + E_71200667.getUser().getNama() + "] - ");
        E_71200667.topup(9000);
        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("[" + E_71190480.getUser().getNama() + "] - ");
        E_71190480.transfer(E_71200667, 2500);
        System.out.println("\n========== KONFIRMASI EMAIL ==========");
        System.out.print("[" + E_71190480.getUser().getNama() + "] - ");
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("[" + E_71200667.getUser().getNama() + "] - ");
        E_71200667.transfer(E_71190480, 9500);
        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("[" + E_71190480.getUser().getNama() + "] - ");
        E_71190480.withdraw(11000);
        System.out.print("[" + E_71200667.getUser().getNama() + "] - ");
        E_71200667.withdraw(1100);
        System.out.println("\n========== AKHIR ==========");
        E_71190480.getInfo();
        E_71200667.getInfo();
    }
